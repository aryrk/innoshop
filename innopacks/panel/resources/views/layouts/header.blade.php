<div class="header-box d-flex justify-content-between align-items-center" style="top: 30px;">
    ...
    <div class="d-flex justify-content-end right-tool">
        <div class="header-item dropdown d-flex align-items-center d-none d-lg-flex">
            <div class="wh-20 me-2"><img src="{{ image_origin('images/flag/' . panel_locale_code() . '.png') }}"
                    class="img-fluid"></div>
        ...
        <div class="header-item dropdown d-flex align-items-center">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ front_route('home.index') }}"
                        target="_blank">{{ __('panel/dashboard.frontend') }}</a></li>
                <li><a class="dropdown-item"
                        href="{{ panel_route('account.index') }}">{{ __('panel/dashboard.profile') }}</a></li>
                <li><a class="dropdown-item"
                        href="{{ panel_route('logout.index') }}">{{ __('panel/dashboard.sign_out') }}</a></li>
            </ul>
        </div>
    </div>
</div>
